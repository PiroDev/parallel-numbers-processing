...
echo "RUN unit testing for serial library build with valgrind"
...
echo "RUN unit testing for multithread library build with valgrind"
...
echo "RUN stress testing for multithred and serial libraries (result compare)"
cd build
